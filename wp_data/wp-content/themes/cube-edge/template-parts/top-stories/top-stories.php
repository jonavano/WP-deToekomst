...
$number_of_top_stories_items     = get_theme_mod( 'number_of_top_stories_items', 4 );

$query = new WP_Query( apply_filters( 'cube_edge_top_stories_args', array(
	'post_type'           => 'post',
	'post_status'         => 'publish',
	'posts_per_page'      => absint( $number_of_top_stories_items ),
	'cat'                 => $top_stories_id,
	'offset'              => 0,
